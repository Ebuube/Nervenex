...
$(function () {
	...
	function createQuiz(category_id="", duration=0) {
		...
		$.ajax({
			url: 'http://web-01.brainspark.tech.tech/nervenex/api/v1/quizzes',
			type: 'POST',
			dataType: 'json',
	...
	function postQuiz(user=null, duration=null) {
		...
		if (new_cat.value.length > 0) {
			...
			// Creat new category
			$.ajax({
				url: 'http://web-01.brainspark.tech.tech/nervenex/api/v1/categories',
				type: 'POST',
				dataType: 'json',
				contentType: 'application/json',
				data: `${JSON.stringify(payload)}`
	...
	function uploadQuestions(quiz=null) {
		...
		for (let i = 0; i < allQuestions.length; i++) {
			...
			$.ajax({
				url: 'http://web-01.brainspark.tech.tech/nervenex/api/v1/questions',
				type: 'POST',
				dataType: 'json',
				contentType: 'application/json',
				data: `${JSON.stringify(payload)}`
